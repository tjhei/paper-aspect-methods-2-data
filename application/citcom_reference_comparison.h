...
#ifndef __aspect__initial_conditions_citcom_reference_comparison_h
#define __aspect__initial_conditions_citcom_reference_comparison_h
...
namespace aspect
{
  namespace InitialConditions
  {
     ...
     */
    template <int dim>
    class CitcomReferenceComparison : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
      ...
      private:
        ...
        /*
         * Amplitude of the temperature jump at the lower boundary.
         */
        double dT;
